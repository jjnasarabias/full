...
terragrunt apply --all --non-interactive --queue-include-external --no-auto-approve --target 'module.acr_cache["datadog-synthetics-private-location"].module.solution_cap.module.base.null_resource.validations' --target 'module.acr_cache["datadog-synthetics-private-location"].module.solution_cap.module.base.random_string.random_fragment' --target 'module.acr_cache["datadog-synthetics-private-location"].azapi_resource.cache_task'